...
int* genTabNotes(int t);
//    Renvoie un tableau de taille t, dont les éléments sont des entiers aléatoires compris entre 0 et 20
...
void rangerNotes(int* Tab,int n);
/*
    Données : Tab un tableau d'entiers de taille n
    Resultat : modifie le tableau Tab de sorte que toutes les notes inférieures 
               strictement à 10 soient placées avant toutes celles supérieures ou égales à 10
               algo de complexite O(n)
*/
