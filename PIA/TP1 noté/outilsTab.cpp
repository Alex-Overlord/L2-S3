...
/* a A COMPLETER
   Quel est le temps approximatif (à 0.1 sec près) d'exécution de ssTabSomMax4 pour un tableau de 10 millions d'éléments ?
   Réponse : 0.6e-01 secondes
 */
...
/*
  somPartiel = 0; somMax = 0;

  for (int k=0 ; k < taille ; ++k) {
    somPartiel = max(0, somPartiel + T[k]);
    somMax = max(somMax, somPartiel);
  }
*/
